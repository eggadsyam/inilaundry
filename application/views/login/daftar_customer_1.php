...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="Welcome"><img src="<?php echo base_url(); ?>assets/tema/images/banner.png" height="60px" alt=""></a>
           ...
           <div class="logo mb-3">
             <div class="col-md-12 text-center">
              <h1>Daftar</h1>
                   ...
                   <form action="PDaftar" method="post">
                           ...
                           <div class="form-group">
                              ...
                              <input type="password" name="password" class="form-control" placeholder="Password" equired>
                           </div>
                           <div class="form-group">
                              <!--<p class="text-center">By signing up you accept our <a href="#">Terms Of Use</a></p>-->
                           </div>
                           <div class="col-md-12 text-center ">
                              <button type="submit" class=" btn btn-block mybtn btn-primary tx-tfm" name="daftar-customer">Daftar</button>
                           </div>
                           <div class="form-group">
                              <p class="text-center"><a href="Masuk.php" id="signup"></a></p>
                           </div>
                        </form>
