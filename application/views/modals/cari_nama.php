    ...
    <div class="container">
            <div class="row justify-content-left mb-5 pb-3">
              <div class="col-md-12 heading-section text-left ftco-animate">
                ...
                <h2><span>Ditemukan hasil</span> <?php echo "$nama_tempat"?></h2>
                <div class="row">
                  <div class="col-3">
                  Fasilitas <br>
    ...
    $lng1   = $_POST['lng'];
      ...
      if (isset($_POST['fasilitas'])) {
        ...
        if ($id_harga==2) {
           ...
           $query = mysqli_query($koneksi,"SELECT * FROM laundry where concat(nama_laundry,   alamat) like '%$nama_tempat%' and fasilitas='antar jemput' and (harga_regular between '$harga1' and '$harga2') ORDER BY id_laundry");

        }else if ($id_harga==3) {

           $query = mysqli_query($koneksi,"SELECT * FROM laundry where concat(nama_laundry,   alamat) like '%$nama_tempat%' and fasilitas='antar jemput' and (harga_cepat between '$harga1' and '$harga2') ORDER BY id_laundry");
  
        } else if ($id_harga==4) {

           $query = mysqli_query($koneksi,"SELECT * FROM laundry where concat(nama_laundry,   alamat) like '%$nama_tempat%' and fasilitas='antar jemput' and (harga_expres between '$harga1' and '$harga2') ORDER BY id_laundry");
    
        }else{

         $query = mysqli_query($koneksi,"SELECT * FROM laundry where concat(nama_laundry,   alamat) like '%$nama_tempat%' and fasilitas='antar jemput' ORDER BY id_laundry");
        ...
        if ($id_harga==2) {
           ...
           $query = mysqli_query($koneksi,"SELECT * FROM laundry where concat(nama_laundry,   alamat) like '%$nama_tempat%' and (harga_regular between '$harga1' and '$harga2') ORDER BY id_laundry");
      
        }else if ($id_harga==3) {

           $query = mysqli_query($koneksi,"SELECT * FROM laundry where concat(nama_laundry,   alamat) like '%$nama_tempat%' and (harga_cepat between '$harga1' and '$harga2') ORDER BY id_laundry");
    
        } else if ($id_harga==4) {

           $query = mysqli_query($koneksi,"SELECT * FROM laundry where concat(nama_laundry,   alamat) like '%$nama_tempat%' and (harga_expres between '$harga1' and '$harga2') ORDER BY id_laundry");
    
        }else{

        $query = mysqli_query($koneksi,"SELECT * FROM laundry where concat(nama_laundry, alamat) like '%$nama_tempat%' ORDER BY id_laundry");
        }
...
?>
              <div class="col-md-4 d-flex">
                <div class="blog-entry align-self-stretch">
                    <a href="<?php echo 'Detail?id='.$data['id_laundry'].''?>" class="block-20" style="background-image: url('<?php echo "assets/tema/images/".$data['foto'].""?>'); width: 350px;"></a>
                    <div class="text mt-3">
                      <!--<div class="meta mb-2">
